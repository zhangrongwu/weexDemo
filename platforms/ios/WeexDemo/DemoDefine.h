...
#define HOME_URL [NSString stringWithFormat:@"http://%@:8080/dist/%@", DEMO_HOST, MAINVC]

#define BUNDLE_URL [NSString stringWithFormat:@"file://%@/bundlejs/%@",[NSBundle mainBundle].bundlePath, MAINVC]
